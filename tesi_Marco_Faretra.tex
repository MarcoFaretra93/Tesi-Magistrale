...
\titolo{Tecnologie Di Reasoning Per Big Data E Knowledge Graphs}
\autore{Marco Faretra}
\matricola{460573}
\relatore{Prof. Paolo Atzeni}
\correlatore{Ing. Luigi Bellomarini} % modifica anche TesiDiaUniroma3.cls se vuoi avere un correlatore
...
\capitolo{Il linguaggio Vadalog}{linguaggio}
\capitolo{Vadalog Reasoner}{engine}
\capitolo{Supporto per nuove features}{algoritmi}
\capitolo{Prove sperimentali}{prove_sperimentali}
\capitolo{Related work}{related_work}
