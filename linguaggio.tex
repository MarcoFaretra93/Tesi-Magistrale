...
\normalfont
\lstset{emph={X, Y, Z, W, V}, emphstyle=\itshape}
\begin{lstlisting}
...
\normalfont
\lstset{emph={X, Y, V, W}, emphstyle=\itshape}
\begin{lstlisting}
...
\normalfont
\lstset{emph={X, Y, V, J, W}, emphstyle=\itshape}
\begin{lstlisting}
...
\normalfont
\lstset{emph={X1, X2, Y, Z}, emphstyle=\itshape}
\begin{lstlisting}
